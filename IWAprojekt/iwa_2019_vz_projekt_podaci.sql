...
DROP SCHEMA IF EXISTS `iwa_2019_vz_projekt`;

CREATE SCHEMA IF NOT EXISTS `iwa_2019_vz_projekt` DEFAULT CHARACTER SET utf8;
USE `iwa_2019_vz_projekt` ;

CREATE USER 'iwa_2019' IDENTIFIED BY 'foi2019';
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE `iwa_2019_vz_projekt`.*
TO 'iwa_2019'@'localhost' IDENTIFIED BY 'foi2019';
